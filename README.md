...
Polyglot client SDKs for **Apostille Me**. The repository is intentionally transport-oriented: generated and handwritten clients share one endpoint contract while each language keeps idiomatic authentication, retries, and error handling.
...
```js
import { createClient } from '@apostille-me/apme-clients';
